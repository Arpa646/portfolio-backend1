...
const requestPasswordReset = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // const link = `https://foodu-delta.vercel.app/api/auth/reset-password/${user._id}`;
    const link = `${config_1.default.url}/api/auth/reset-password/${user._id}`;
    // Send Email
    const transporter = nodemailer_1.default.createTransport({
        ...
        secure: false,
        auth: {
            user: config_1.default.email_sender,
            pass: config_1.default.eamil_pass,
        },
    });
